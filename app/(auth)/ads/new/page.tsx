...
export default function NewAdPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto py-5 px-6">
      <h1 className="text-3xl font-bold text-[#1F2937] mb-2 text-center">Add New Ad</h1>
      ...
      <div className="bg-[#F9FAFB] p-8 rounded-xl shadow-lg border border-[#E5E7EB]">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex space-x-4">
            <Button type="submit" disabled={loading}             className="bg-[#FF9100] text-amber-700 font-semibold hover:bg-[#E68200] transition-colors rounded-lg px-6 py-2">
